          ...
          <>
            ...
            >
              <div className="flex items-center justify-between gap-2 p-3 border-b border-zinc-200 dark:border-zinc-700">
                <h2 className="text-sm font-semibold text-zinc-800 dark:text-zinc-200">카드 인벤토리</h2>
                <button
                  type="button"
              ...
              <div className="flex-1 overflow-y-auto p-2">
                <div className="grid grid-cols-3 gap-1.5">
                  {Array.from({ length: 3 * 50 }, (_, i) => (
                    ...
                    >
                      <span className="text-[10px] text-zinc-400 dark:text-zinc-500">{i + 1}</span>
                    </div>
                  ))}
                </div>
              </div>
                      ...
                      <>
                        ...
                        >
                          {Array.from({ length: slotCount }, (_, i) => (
                            <div
                              key={i}
                              className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-zinc-300 bg-zinc-50 dark:border-zinc-600 dark:bg-zinc-700 min-w-0"
